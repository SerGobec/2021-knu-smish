...
best_recall_score = max(history.history['val_recall'])
print('Best Score by val_Recall: {}'.format(best_recall_score))
...
model1.compile(loss = 'binary_crossentropy', optimizer = 'nadam', metrics=['Recall','accuracy'])
...
best_recall_score1 = max(history1.history['val_recall'])
print('Best Score by val_Recall: {}'.format(best_recall_score1))
